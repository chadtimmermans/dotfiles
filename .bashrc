...
# customize output of virtualenv name in prompt
prompt_venv(){
  local venv=''
...
PS1="\[\033]0;\w\007\]";
PS1+="\[${bold}\]\n"; # newline
PS1+="\[${blue}\]\$(prompt_venv)"
PS1+="\[${userStyle}\]\u"; # username
PS1+="\[${green}\]@";
PS1+="\[${hostStyle}\]\h"; # host
PS1+="\[${white}\] in ";
PS1+="\[${bold}${orange}\]\W"; # working directory
PS1+="\$(prompt_git \" \[${blue}\]\[${blue}\]\" \"\[${blue}\]\")"; # Git repository details
#PS1+="\n";
if [[ "${USER}" == "root" ]]; then
